...
public class CharactersUtils {
    ...
    private CharactersUtils() {
        throw new UnsupportedOperationException("Cannot be created");
    }

    static int START = 19968;
    static int COUNT = 20902;

    static String firstLetterArray =
    ...
    public static String getFirstLetter(String characters) {
        String str = characters.substring(0, 1);
        ...
        if (index >= 0 && index <= COUNT) {
            return String.valueOf(firstLetterArray.charAt(index));
        }
        return "#";
    }
}
