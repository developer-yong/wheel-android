...
public interface MsaIdInterface extends IInterface {
     ...
     */
    abstract class Stub extends Binder implements MsaIdInterface {
         ...
         */
        public static MsaIdInterface asInterface(IBinder service) {
            if (service == null) {
                return null;
            }
            IInterface iInterface = service.queryLocalInterface(DESCRIPTOR);
            if (iInterface instanceof MsaIdInterface) {
                return (MsaIdInterface) iInterface;
            }
